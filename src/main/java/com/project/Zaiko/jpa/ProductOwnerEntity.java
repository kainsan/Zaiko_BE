...
@Entity
@Table(name = "m_product_owner")
@NamedQuery(name = "ProductOwnerEntity.findAll", query = "SELECT p FROM ProductOwnerEntity p")
public class ProductOwnerEntity extends CommonEntity implements Serializable {
    ...
    // ProductOwnerCode
    @Column(name = "product_owner_code")
    @JsonProperty("productOwnerCode")
